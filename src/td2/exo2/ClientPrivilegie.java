 ...
 * <p>
 * Un objet ClientPrivilege possède un nom, prénom et CA et d'un privilège
 * (enum)
 * </p>
 *
 */
public class ClientPrivilegie extends Client {
	...
	private int SEUIL_BON_CLIENT;
	private int SEUIL_CLIENT_EXCEPTIONNEL;
	private int SEUIL_CLIENT_VERY_IMPORTANT;

	/**
	 *
	 * Promouvoir un simple client en client privilégié
	 *
	 * @param clientApromouvoir Tente de passer de remplacer un objet Client par
	 * un objet ClientPrivilegie
	 */
	 ...
	 * <p>
	 * On définira le type de client dans le constructeur en se basant sur une
	 * énumération (EnumTypeClientPrivilegie.java)
	 * </p>
	 *
	...
	/**
	 *
	 * Permet de mettre à jour le CA d'un client privilégié
	 *
	 * @param caClient Le CA du client à redefinir
	 */
	@Override
	public void setCaClient(double caClient) {
		//	Version utilisant les énumération
		SEUIL_BON_CLIENT = enumTypeClientPriviliege.BON_CLIENT.getSeuilClientPrivilege();
		SEUIL_CLIENT_EXCEPTIONNEL = enumTypeClientPriviliege.CLIENT_EXCEPTIONNEL.getSeuilClientPrivilege();
		SEUIL_CLIENT_VERY_IMPORTANT = enumTypeClientPriviliege.VERY_IMPORTANT_CLIENT.getSeuilClientPrivilege();	
